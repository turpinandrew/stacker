...
HDRS = main.h density.h queue.h setup.h types.h
OBJS = main.o density.o queue.o setup.o
SRCS = main.c queue.c density.c setup.c
EXE = stack
...
main.o: main.c queue.h Makefile setup.h types.h
